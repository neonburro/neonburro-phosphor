...
export const COPY = {
  en: {
    ...
    wallet_buy_open: 'open the buy desk',
    wallet_buy_note: 'jupiter routes it. your wallet signs it. nothing is ever held here.',
    wallet_buy_fail: 'the desk did not open. try again in a minute.',
    wallet_app: 'the app is coming. this room is the beta.',
    wallet_tape: 'the last of the tape',
    shell_holders: 'holders in the room',
    ledger_kicker: 'the ledger room',
    ledger_title: 'value moves. history remains.',
    ledger_line: 'epoch takes a reading every hour and keeps the week. holders read it here first.',
    ledger_holders_chart: 'holders • history remains',
    ledger_price_chart: 'price • value moves',
    ledger_week: 'the week',
    ledger_now: 'now',
    ledger_price: 'price',
    ledger_holders: 'holders',
    ledger_pool: 'pool depth',
    ledger_volume: 'day volume',
    ledger_buys: 'buys today',
    ledger_sells: 'sells today',
  ...
  ja: {
    ...
    wallet_buy_open: '買い場を開く',
    wallet_buy_note: 'ルートはjupiter。署名はあなたのウォレット。ここでは何も預からない。',
    wallet_buy_fail: '買い場が開かなかった。少ししてからもう一度。',
    wallet_app: 'アプリは準備中。この部屋がベータ。',
    wallet_tape: 'テープの最新',
    shell_holders: '部屋にいる保有者',
    ledger_kicker: '記録の部屋',
    ledger_title: '価値は動く。記録は残る。',
    ledger_line: 'epochが毎時間読み取り、一週間を預かる。保有者が最初に読む。',
    ledger_holders_chart: '保有者 • 記録は残る',
    ledger_price_chart: '価格 • 価値は動く',
    ledger_week: 'この一週間',
    ledger_now: 'いま',
    ledger_price: '価格',
    ledger_holders: '保有者',
    ledger_pool: 'プールの深さ',
    ledger_volume: '24時間の出来高',
    ledger_buys: '本日の買い',
    ledger_sells: '本日の売り',
  ...
  zh: {
    ...
    wallet_buy_open: '打开买入台',
    wallet_buy_note: '由 jupiter 撮合，你的钱包签名，这里从不代管任何东西。',
    wallet_buy_fail: '买入台没有打开。过一分钟再试。',
    wallet_app: '应用正在路上。这个房间就是测试版。',
    wallet_tape: '最新成交',
    shell_holders: '屋里的持有者',
    ledger_kicker: '账簿房间',
    ledger_title: '价值流动。记录长存。',
    ledger_line: 'epoch 每小时记一笔，保管这一周。持有者最先读到。',
    ledger_holders_chart: '持有者 • 记录长存',
    ledger_price_chart: '价格 • 价值流动',
    ledger_week: '这一周',
    ledger_now: '现在',
    ledger_price: '价格',
    ledger_holders: '持有者',
    ledger_pool: '池深',
    ledger_volume: '24小时成交量',
    ledger_buys: '今日买入',
    ledger_sells: '今日卖出',
